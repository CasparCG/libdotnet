...
{
	public class CasparHostsManager
	{
		...
		Dictionary<string, CasparChannelInformation> channelInfos_;
		...
		public bool HasChannels { get { return channelInfos_.Count > 0; } }

		public IEnumerable<CasparChannelInformation> ChannelInfos
		{
			get
			{
		...
		public CasparChannelInformation GetChannelInfo(string label)
		{
	...
	public class DeviceHolder
	{
		...
		public List<CasparChannelInformation> Channels { get; private set; }
		...
		{
			foreach (CasparChannelInformation info in Channels)
